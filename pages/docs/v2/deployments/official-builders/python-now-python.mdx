...
Most frameworks use their own implementation of routing but you can use a catch-all route to circumvent the framework and instead use [Now Routing Layer](/docs/v2/deployments/routes) to match a route to a Lambda.

The example above can be seen live as <https://python-flask-298quau1w.now.sh>
